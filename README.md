...
4. Auth process and role-based access (Spring Security + JWT token)
5. User flows: 2-steps registration, password reset, sign in
6. Unit-testing (Groovy Spock)
7. Blackbox-testing (Testcontainers + Rest Assured)
